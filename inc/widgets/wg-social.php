    ...
    function widget($args, $instance) {
        ...
        <ul>
            ...
            if( ! empty( $sh_option['social-facebook'] ) ) {
                echo '<li class="icon_social icon_facebook"><a href="'.$sh_option['social-facebook'].'" rel="nofollow" target="_blank"><i class="fab fa-facebook"></i></a></li>';
            }
            ...
            if( ! empty( $sh_option['social-google'] ) ) {
                echo '<li class="icon_social icon_google"><a href="'.$sh_option['social-google'].'" rel="nofollow" target="_blank"><i class="fab fa-google"></i></a></li>';
            }
            ...
            if( ! empty( $sh_option['social-linkedin'] ) ) {
                echo '<li class="icon_social icon_linkedin"><a href="'.$sh_option['social-linkedin'].'" rel="nofollow" target="_blank"><i class="fab fa-linkedin"></i></a></li>';
            }
            if( ! empty( $sh_option['social-pinterest'] ) ) {
                echo '<li class="icon_social icon_pinterest"><a href="'.$sh_option['social-pinterest'].'" rel="nofollow" target="_blank"><i class="fab fa-pinterest"></i></a></li>';
            }
            if( ! empty( $sh_option['social-instagram'] ) ) {
                echo '<li class="icon_social icon_instagram"><a href="'.$sh_option['social-instagram'].'" rel="nofollow" target="_blank"><i class="fab fa-pinterest"></i></a></li>';
            }
            ?>
        </ul>
