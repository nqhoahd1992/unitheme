...
class Gtid_Products_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'slider_products',
            '3B - Products Slider',
            array( 'description'  =>  'Hiển thị một slider danh sách sản phẩm chạy ngang' )
        );
    }
    ...
    function form($instance) {
        ...
        <p>
            ...
            <?php
            wp_dropdown_categories(array('name'=> $this->get_field_name('cat'),'selected'=>$instance['cat'],'orderby'=>'Name','hierarchical'=>1,'show_option_all'=>__('Chọn chuyên mục','sh_theme'),'hide_empty'=>'0', 'taxonomy' => 'product_cat'));
            ?>
        </p>
