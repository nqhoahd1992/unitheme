	...
	<?php
		if ( has_post_thumbnail() ) 
		{
			...
			foreach( $attachment_ids as $attachment_id ) {
			   ...
			   $html .= '<div class="zoom"><img src="'.$imgfull_src[0].'" /><img src="'.$image_src[0].'" /><a href="'.$imgfull_src[0].'" class="dev3b-popup fas fa-expand" data-fancybox="product-gallery"></a></div>';
			}
